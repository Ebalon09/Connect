                    ...
                    <?php if(isset($_SESSION['userid']) && $_SESSION['userid']){?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="#">Meine Posts</a>
            ...
            <div class="main">
                <?php foreach ($result as $data) { ?>
                    <div class="item">
                        ...
                        <p><?= $data['text']; ?></p>
                        <?php if(isset($_SESSION['userid']) && $_SESSION['userid']){?>
                            <a href="./index.php?controller=MyPostController&action=updateAction&id=<?= $data['id'] ?>" <button id="editButton" class="btn btn-primary" type="Submit" name="action" value="Edit" >Edit</button> </a>
                            <a href="./index.php?controller=MyPostController&action=deleteAction&id=<?= $data['id'] ?>" <button id="deleteButton" class="btn btn-danger" type="submit" name="action" value="Delete">Delete</button> </a>
                        <?php } ?>
                    </div>
                <?php }?>
            </div>
